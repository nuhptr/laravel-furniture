...
@section('content')
        ...
        <div class="my-4 flex flex-wrap md:my-12">
            ...
            <div class="flex-1">
                <div class="slider">
                    ...
                    <div class="preview">
                        <div class="item h-full overflow-hidden rounded-lg">
                            <img src="{{ url('./frontend/images/content/showcase-1.front.jpg') }}" alt="front"
                                class="h-full w-full rounded-lg object-cover" />
                        </div>
                    </div>
            ...
            <div class="flex-1 px-4 md:p-6">
                ...
                <a href="cart.html"
                    class="mt-4 inline-flex rounded-full bg-pink-400 px-8 py-3 text-black transition-all duration-200 focus:bg-black focus:text-pink-400"><svg
    ...
    <section class="bg-gray-100 px-4 py-16">
        <div class="container mx-auto">
            ...
            <div class="-mx-3 mb-4 flex overflow-x-auto">
                <div class="flex-none px-3" style="width: 320px">
                    <div class="relative rounded-xl bg-white p-4 pb-8">
                        <div class="card-shadow h-36 w-full overflow-hidden rounded-xl">
