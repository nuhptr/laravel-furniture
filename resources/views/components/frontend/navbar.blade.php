 <!-- START: HEADER -->
 <header class="{{ \Route::current()->getName() == 'index' ? 'absolute' : '' }} z-50 w-full px-4">
     <div class="container mx-auto py-5">
         <div class="flex-stretch flex items-center">
             ...
             <div class="w-auto">
                 <ul class="invisible fixed inset-0 flex flex-col items-center justify-center bg-white opacity-0 md:visible md:relative md:flex md:flex-row md:items-center md:bg-transparent md:opacity-100"
                     id="menu">
                     <li class="mx-3 py-6 md:py-0">
                         <a href="#"
                             class="{{ \Route::current()->getName() == 'index' ? ' md:text-white' : 'md:text-black' }} text-black hover:underline">Showcase</a>
                     </li>
                     <li class="mx-3 py-6 md:py-0">
                         <a href="#"
                             class="{{ \Route::current()->getName() == 'index' ? ' md:text-white' : 'md:text-black' }} text-black hover:underline">Catalog</a>
                     </li>
                     <li class="mx-3 py-6 md:py-0">
                         <a href="#"
                             class="{{ \Route::current()->getName() == 'index' ? ' md:text-white' : 'md:text-black' }} text-black hover:underline">Delivery</a>
                     </li>
                     <li class="mx-3 py-6 md:py-0">
                         <a href="#"
                             class="{{ \Route::current()->getName() == 'index' ? ' md:text-white' : 'md:text-black' }} text-black hover:underline">Rewards</a>
                     </li>
                 </ul>
             </div>
             <div class="w-auto">
                 <ul class="flex items-center">
                     <li class="ml-6 block md:hidden">
                         <button id="menu-toggler"
                             class="relative z-50 flex h-8 w-8 items-center justify-center text-black focus:outline-none md:text-white">
                     ...
                     <li class="ml-6">
                         <a id="header-cart" class="flex h-8 w-8 items-center justify-center text-black md:text-white"
                             href="cart.html">
